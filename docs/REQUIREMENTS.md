...
When people contribute, they shouldn't add features directly. They should contribute a skill that transforms the codebase. Users fork the repo, run skills to customize, and end up with clean code that does exactly what they need - not a bloated system trying to support everyone's use case simultaneously.
...
### Telegram
- Using node-telegram-bot-api for Telegram Bot API
- Messages stored in SQLite, polled by router
- Bot token authentication via .env
...
### Skills
- `/setup` - Install dependencies, configure Telegram, start services
- `/customize` - General-purpose skill for adding capabilities (new integrations, behavior changes)
...
- **Main channel**: Private Telegram chat with the bot
